...
const I18N = {
    tr: {
        ...
        'tab.infra': 'Altyapı',
        'infra.banner': '<strong>Altyapı kurulumu</strong> · Bir kez çalıştırılır, tekrar çalıştırmak zararsızdır. Bu işlemler denetim kaydına yazılır.',
        'infra.bq.title': 'Veri Ambarı (BigQuery)',
        'infra.bq.p1': 'Olay ambarını oluşturur: <code>altare_analytics.events</code> tablosu, tarih bölümlemesi, kümeleme ve <code>require_partition_filter</code> ile. <strong>Bölge sonradan değiştirilemez</strong> — <code>europe-west1</code> seçili, veri AB\'de kalır.',
        'infra.bq.p2': 'Bu çağrı yapılana kadar olaylar <strong>yalnızca Firestore\'a</strong> yazılır ve loglara açık bir uyarı düşer — veri kaybolmaz.',
        'infra.bq.btn': 'Veri Ambarını Kur',
        'infra.bq.running': 'Kuruluyor…',
        'infra.bq.ok': 'Veri ambarı hazır',
        'infra.bq.fail': 'Kurulum başarısız',
        'infra.bq.table': 'Tablo',
        'infra.bq.region': 'Bölge',
        'infra.bq.expiry': 'Bölüm ömrü (gün)',
        'infra.bq.next': 'Bundan sonraki olaylar hem Firestore\'a hem BigQuery\'ye yazılır. İlk satırların düştüğünü Cloud Console > BigQuery üzerinden doğrula.',
        ...
        'tab.auto-heal': 'Auto-Heal',
        'tab.device-intel': 'Device Intelligence',
        'tab.player-rollback': 'Oyuncu State Rollback',
        'tab.industry-benchmark': 'Sektör Benchmark',
        ...
        // ── Auto-Heal ──
        'autoheal.banner': '<strong>🩺 AI Auto-Heal</strong> — Sentinel uyarısı tetiklendiğinde AI Doctor (Claude Opus 4.8) somut bir Remote Config reçetesi üretir. <strong>"Uygula"</strong> dediğinde değişiklik anlık oyuna gider — yeni APK gerekmez. Snapshot ile rollback garantili.',
        'autoheal.history': 'Reçete Geçmişi',
        'autoheal.empty': 'Henüz reçete yok. Sentinel sekmesinde bir uyarıya tıklayıp "AI Çözüm Öner" butonuna bas.',
        'autoheal.prescribe': 'AI Çözüm Öner',
        'autoheal.thinking': 'Düşünüyor…',
        'autoheal.apply': 'Uygula',
        'autoheal.applying': 'Uygulanıyor…',
        'autoheal.rollback': 'Geri Al',
        'autoheal.rollingBack': 'Geri alınıyor…',
        'autoheal.later': 'Şimdi Değil',
        'autoheal.confirmApply': 'Bu reçete oyunundaki ayarları anlık değiştirecek. Devam edilsin mi?',
        'autoheal.confirmRollback': 'Bu reçete geri alınsın mı? Önceki ayarlara dönülecek.',
        'autoheal.applySuccess': '✅ Reçete uygulandı — oyun anlık çekecek',
        'autoheal.rollbackSuccess': '↺ Önceki ayarlara dönüldü',
        'autoheal.error': '⚠️ Hata oluştu',
        'autoheal.dataInsufficient': 'AI veri yetersiz olduğu için reçete üretemedi. Daha fazla event verisi toplandığında tekrar dene.',
        'autoheal.modalTitle': 'AI Reçetesi',
        'autoheal.label.rootCause': 'Kök Sebep Hipotezi',
        'autoheal.label.changes': 'Önerilen Değişiklikler',
        'autoheal.label.success': 'Başarı Kriteri',
        'autoheal.label.rollback': 'Geri Alma Tetiği',
        'autoheal.label.warnings': '⚠️ Uyarılar',
        'autoheal.status.proposed': 'Önerildi',
        'autoheal.status.applied': 'Uygulandı',
        'autoheal.status.rolled_back': 'Geri Alındı',
        'autoheal.status.experimenting': 'Deneyde',

        // ─── Dönüşüm Hunileri ───
        'funnel.title': '🔻 Dönüşüm Hunileri',
        'funnel.banner': '<strong>Oyuncular tam olarak nerede kopuyor?</strong> Huni, <strong>sıralı bir yoldur</strong> — bağımsız sayaçlardan farklı olarak her adım öncekinden <em>sonra</em> gerçekleşmiş olmak zorundadır. Oranlar yalnızca <strong>penceresi kapanmış</strong> oyunculardan hesaplanır: huniye az önce girenler "koptu" sayılmaz.',
        'funnel.empty': 'Henüz huni yok. Yukarıdan hazır bir huni ekleyerek başla — ilk sonuç bir sonraki ölçümde (6 saatte bir) ya da <strong>Şimdi Ölç</strong> ile görünür.',
        'funnel.addPreset': 'Hazır huni ekle:',
        'funnel.preset.onboarding': 'Onboarding',
        'funnel.preset.monetization': 'Monetizasyon',
        'funnel.preset.rewarded_ad': 'Ödüllü Reklam',
        'funnel.metaTotal': 'huni',
        'funnel.metaMeasured': 'ölçüldü',
        'funnel.overall': 'Genel dönüşüm',
        'funnel.window': 'Pencere',
        'funnel.entered': 'Huniye giren',
        'funnel.inProgress': 'hâlâ pencerede',
        'funnel.lookback': 'geriye bakış',
        'funnel.notMeasuredYet': 'Henüz ölçülmedi — "Şimdi Ölç" ile hesapla.',
        'funnel.worstStep': 'En büyük kopuş',
        'funnel.lost': 'oyuncu burada kayboluyor',
        'funnel.measure': 'Şimdi Ölç',
        'funnel.measuring': 'Ölçülüyor…',
        'funnel.measureSuccess': '📊 Huni ölçüldü',
        'funnel.delete': 'Sil',
        'funnel.deleteSuccess': '🗑 Huni silindi',
        'funnel.confirmDelete': 'Bu huni silinsin mi? Ölçüm geçmişi de gider.',
        'funnel.createSuccess': '🔻 Huni eklendi — ilk sonuç için "Şimdi Ölç" e bas',
        'funnel.noGame': 'Önce üstten bir oyun seç.',
        'funnel.error': '⚠️ Huni işlemi başarısız',

        // ─── Denetim Kaydı + KVKK/GDPR ───
        'tab.audit': 'Denetim Kaydı',
        'audit.banner': '<strong>📋 Denetim Kaydı</strong> — Kim, ne zaman, ne yaptı? Canlı oyuna config yazan her işlem buraya düşer. <strong>Reddedilen girişimler de</strong> kayda geçer — denetçiyi asıl ilgilendiren onlardır. Kayıt <strong>değişmezdir</strong>: silinemez, düzenlenemez.',
        'audit.title': 'Son İşlemler',
        'audit.refresh': 'Yenile',
        'audit.loading': 'Yükleniyor…',
        'audit.empty': 'Yenile\'ye basarak bu oyunun denetim kaydını getir.',
        'audit.noEntries': 'Bu oyun için henüz denetim kaydı yok. Bir reçete uygulandığında, deney başlatıldığında veya veri silindiğinde burada görünür.',
        'audit.denied': 'reddedildi',
        'audit.systemActor': 'sistem (otomatik)',
        'audit.error': 'Denetim kaydı alınamadı',
        'gdpr.title': '🔒 Oyuncu Verisi — Silme & Dışa Aktarma',
        'gdpr.legal': 'KVKK md. 7 · GDPR md. 15/17',
        'gdpr.banner': 'Bir oyuncu <strong>"verimi silin"</strong> dediğinde bu butonu kullan. Oyuncunun tüm event\'leri, retention kaydı ve state snapshot\'ları silinir. <strong>Toplu istatistikler</strong> (retention oranı, huni, günlük stats) geri hesaplanmaz — onlar anonim toplamlardır, tek bir oyuncuyu tanımlamaz. Her iki işlem de <strong>denetim kaydına</strong> geçer.',
        'gdpr.export': '⬇ Verisini Dışa Aktar (JSON)',
        'gdpr.delete': '🗑 Verisini Kalıcı Sil',
        'gdpr.needId': 'Önce yukarıdaki kutuya playerAnonId yaz.',
        'gdpr.confirmPrompt': 'BU İŞLEM GERİ ALINAMAZ.\n\nOyuncunun tüm verisi kalıcı olarak silinecek. Onaylamak için playerAnonId\'yi aynen yaz:\n\n{id}',
        'gdpr.confirmMismatch': 'Girilen kimlik eşleşmedi — silme iptal edildi.',
        'gdpr.exportDone': 'Dışa aktarıldı, dosya indirildi',
        'gdpr.truncated': 'event sayısı tavana takıldı, kayıt eksik olabilir',
        'gdpr.deleteDone': 'Oyuncu verisi silindi',
        'gdpr.events': 'event',
        'gdpr.rollup': 'retention kaydı',
        'gdpr.snapshots': 'snapshot',
        'section.levelDistributionMeta': 'Aralık bazlı tamamlama · son 24 saat',

        // ─── A/B Deneyleri ───
        'exp.title': '🧪 A/B Deneyleri',
        'exp.banner': '<strong>Değişiklik işe yaradı mı?</strong> Bir reçeteyi herkese birden uygulamak yerine <strong>%10\'luk bir dilimde</strong> test et. Kalan %90 kontrol grubudur; fark istatistiksel olarak anlamlıysa yaygınlaştırılır. Deneme grubu zarar veriyorsa sistem <strong>kendiliğinden durdurur</strong>.',
        'exp.empty': 'Henüz deney yok. Bir reçetede <strong>"%10\'da Test Et"</strong> butonuna bas.',
        'exp.metaTotal': 'deney',
        'exp.metaRunning': 'çalışıyor',
        'exp.promote': '%10\'da Test Et',
        'exp.starting': 'Başlatılıyor…',
        'exp.startSuccess': '🧪 Deney başladı — oyuncuların %10\'u yeni değerleri görecek',
        'exp.confirmPromote': 'Bu reçete oyuncuların %10\'unda test edilecek. Kalan %90 mevcut değerlerde kalır ve kontrol grubu olur.\n\nSonuç istatistiksel olarak anlamlı çıkarsa yaygınlaştırabilirsin. Deneme grubu zarar verirse sistem kendiliğinden durdurur.\n\nBaşlatılsın mı?',
        'exp.inExperiment': 'Bu reçete şu an bir deneyde ölçülüyor.',
        'exp.currentValues': '(mevcut değerler)',
        'exp.exposure': 'Katılım',
        'exp.minSample': 'Gereken örneklem',
        'exp.needPerVariant': 'varyant başına gereken',
        'exp.guardrail': 'GÜVENLİK',
        'exp.stoppedReason': 'Durdurma sebebi',
        'exp.shipped': 'Yaygınlaştırıldı',
        'exp.abandoned': 'Vazgeçildi',
        'exp.status.running': 'Çalışıyor',
        'exp.status.stopped': 'Durduruldu',
        'exp.status.concluded': 'Sonuçlandı',
        'exp.verdict.winner': '✅ Kazanan var',
        'exp.verdict.control_wins': '⚠️ Mevcut ayar daha iyi',
        'exp.verdict.no_difference': '➖ Anlamlı fark yok',
        'exp.verdict.insufficient_sample': '⏳ Örneklem yetersiz — sonuç okunmaz',
        'exp.verdict.guardrail_breach': '🛑 Güvenlik eşiği aşıldı',
        'exp.verdict.assignment_mismatch': '🛑 İstemci/sunucu ataması uyuşmuyor — sonuç geçersiz',
        'exp.analyze': 'Şimdi Ölç',
        'exp.analyzing': 'Ölçülüyor…',
        'exp.analyzeSuccess': '📊 Ölçüm tamamlandı',
        'exp.ship': 'Yaygınlaştır',
        'exp.shipSuccess': '🚀 Kazanan varyant tüm oyunculara uygulandı',
        'exp.confirmShip': 'Kazanan varyantın değerleri TÜM oyunculara uygulanacak ve deney kapanacak. Devam edilsin mi?',
        'exp.stop': 'Durdur',
        'exp.stopSuccess': '⏹ Deney durduruldu — oyuncular önceki değerlere döndü',
        'exp.confirmStop': 'Deney durdurulsun mu? Oyuncular anında önceki değerlere döner. Toplanan ölçümler korunur.',
        'exp.abandon': 'Vazgeç',
        'exp.abandonSuccess': '🗑 Deneyden vazgeçildi — değerler değişmedi',
        'exp.confirmAbandon': 'Bu deneyden vazgeçilsin mi? Hiçbir değer değişmez, deney arşivlenir.',
        'autoheal.risk.low': 'düşük risk',
        'autoheal.risk.medium': 'orta risk',
        'autoheal.risk.high': 'yüksek risk',
        'autoheal.scope': '<strong>Kapsam:</strong> Auto-Heal <strong>config-driven sorunları</strong> çözer (level zorluk, reklam frekansı, IAP fiyatı, FPS limiti, particle quality). Kod kaynaklı bug\'lar için <strong>Crash & Performance</strong> sekmesine + AI Copilot\'a sor. State bozulmaları için <strong>Oyuncu State Rollback</strong> kullan.',

        // ── Device Intelligence (Umut Can'in onerisi) ──
        'device.banner': '<strong>🎮 Device Intelligence</strong> — Hangi GPU ailesi, RAM tier veya cihaz modelinde crash/ANR/FPS uyarısı yığılıyor? AI optimizasyon önerileri için somut hedefler.',
        'device.anrs': 'ANR (24h)',
        'device.memWarn': 'Bellek Uyarısı',
        'device.avgFps': 'Ort. FPS',
        'device.lowEndRatio': 'Düşük RAM Cihaz Oranı',
        'device.gpuFamily': 'GPU Ailesi Breakdown',
        'device.problemDevices': 'Problemli Cihaz Modelleri',
        'device.memoryTier': 'RAM Tier Dağılımı',
        'device.empty': 'SDK v2.3+ ile event toplandığında burada GPU ailesine göre crash/ANR/FPS dağılımı görürsün.',
        'device.problemEmpty': 'Crash/ANR event\'leri toplandığında en problemli cihazlar buraya gelir.',
        'device.memoryEmpty': 'Bellek dağılımı verisi henüz yok.',

        // ── Player State Rollback (Yigit Ozturk'un onerisi) ──
        'rollback.banner': '<strong>↺ Oyuncu State Rollback</strong> — Whale oyuncu progress kaybetti? Bug\'lı patch oyuncuları broken state\'e attı? Buradan oyuncunun anonim ID\'siyle önceki snapshot\'larını listele, tek tıkla geri yükle. Oyun anlık çeker.',
        'rollback.lookup': 'Oyuncu Ara',
        'rollback.search': 'Ara',
        'rollback.restore': 'Geri Yükle',
        'rollback.empty': 'playerAnonId yapıştırıp Ara\'ya bas — oyuncunun snapshot geçmişi listelenir.',
        'rollback.idPlaceholder': 'playerAnonId (örn: a3f9c2...)',
        'rollback.idRequired': 'playerAnonId boş olamaz.',
        'rollback.noneFound': 'Bu oyuncu için snapshot bulunamadı.',
        'rollback.confirmRestore': 'Bu snapshot oyuncunun state\'ini değiştirecek. Devam edilsin mi?',
        'rollback.restored': '✅ Restore queue\'lendi. Oyuncu oyununa girince state geri yüklenecek.',

        // ── Industry Benchmark (Cross-Tenant Network Effect) ──
        'industry.banner': '<strong>📊 Sektör Benchmark</strong> — Altare platformundaki tüm <em>aynı tür</em> oyunların anonimleştirilmiş ortalamaları. Senin metriklerin sektör medyanı + top %10 ile karşılaştırılır. Min 3 oyun gerekli (privacy).',
        'industry.title': 'Sektör Karşılaştırması',
        'industry.refresh': '↻ Güncel Veriyi Çek',
        'industry.loading': 'Sektörel veri çekiliyor…',
        'industry.empty': '"Güncel Veriyi Çek" tıklayınca sektörel benchmark yüklenir. Yeterli oyun (min 3) yoksa "henüz hazır değil" mesajı görürsün.',
        'industry.avgSession': 'Ort. Oturum (s)',
        'industry.failRate': 'Level Fail Oranı',
        'industry.crashRate': 'Crash Oranı',
        'industry.fpsWarnRate': 'FPS Uyarı Oranı',
        'industry.adsPerSession': 'Oturum Başına Reklam',
        'industry.iapPerPlayer': 'Oyuncu Başına IAP',
        'industry.sessionsPerPlayer': 'Oyuncu Başına Oturum',
    ...
    en: {
        ...
        'infra.banner': '<strong>Infrastructure setup</strong> · Run once; running it again is harmless. These actions are written to the audit log.',
        'infra.bq.title': 'Data Warehouse (BigQuery)',
        'infra.bq.p1': 'Creates the event warehouse: the <code>altare_analytics.events</code> table with date partitioning, clustering and <code>require_partition_filter</code>. <strong>The region cannot be changed later</strong> — <code>europe-west1</code> is selected, so data stays in the EU.',
        'infra.bq.p2': 'Until this is run, events are written <strong>to Firestore only</strong> and a clear warning appears in the logs — no data is lost.',
        'infra.bq.btn': 'Set Up Data Warehouse',
        'infra.bq.running': 'Setting up…',
        'infra.bq.ok': 'Data warehouse ready',
        'infra.bq.fail': 'Setup failed',
        'infra.bq.table': 'Table',
        'infra.bq.region': 'Region',
        'infra.bq.expiry': 'Partition expiry (days)',
        'infra.bq.next': 'From now on events are written to both Firestore and BigQuery. Verify the first rows land via Cloud Console > BigQuery.',
        'infra.bq.permHint': 'Permission error: grant the Functions service account BigQuery access (roles/bigquery.dataEditor + roles/bigquery.jobUser).',
        ...
        'tab.auto-heal': 'Auto-Heal',
        'tab.device-intel': 'Device Intelligence',
        'tab.player-rollback': 'Player State Rollback',
        'tab.industry-benchmark': 'Industry Benchmark',
        ...
        // ── Auto-Heal ──
        'autoheal.banner': '<strong>🩺 AI Auto-Heal</strong> — When Sentinel detects an anomaly, AI Doctor (Claude Opus 4.8) generates a concrete Remote Config prescription. Click <strong>"Apply"</strong> and the change goes live instantly — no new APK needed. Snapshot-backed rollback guaranteed.',
        'autoheal.history': 'Prescription History',
        'autoheal.empty': 'No prescriptions yet. Go to Sentinel tab and click "AI Prescribe" on an alert.',
        'autoheal.prescribe': 'AI Prescribe',
        'autoheal.thinking': 'Thinking…',
        'autoheal.apply': 'Apply',
        'autoheal.applying': 'Applying…',
        'autoheal.rollback': 'Rollback',
        'autoheal.rollingBack': 'Rolling back…',
        'autoheal.later': 'Not Now',
        'autoheal.confirmApply': 'This prescription will instantly change live game settings. Continue?',
        'autoheal.confirmRollback': 'Roll back this prescription? Previous settings will be restored.',
        'autoheal.applySuccess': '✅ Prescription applied — game will fetch instantly',
        'autoheal.rollbackSuccess': '↺ Reverted to previous settings',
        'autoheal.error': '⚠️ An error occurred',
        'autoheal.dataInsufficient': 'AI determined data is insufficient. Try again once more event data is collected.',
        'autoheal.modalTitle': 'AI Prescription',
        'autoheal.label.rootCause': 'Root Cause Hypothesis',
        'autoheal.label.changes': 'Proposed Changes',
        'autoheal.label.success': 'Success Criteria',
        'autoheal.label.rollback': 'Rollback Trigger',
        'autoheal.label.warnings': '⚠️ Warnings',
        'autoheal.status.proposed': 'Proposed',
        'autoheal.status.applied': 'Applied',
        'autoheal.status.rolled_back': 'Rolled back',
        'autoheal.status.experimenting': 'In experiment',

        // ─── Conversion Funnels ───
        'funnel.title': '🔻 Conversion Funnels',
        'funnel.banner': '<strong>Where exactly do players drop off?</strong> A funnel is an <strong>ordered path</strong> — unlike independent counters, each step must happen <em>after</em> the previous one. Rates are computed only from players whose <strong>window has closed</strong>: players who just entered are not counted as drop-offs.',
        'funnel.empty': 'No funnels yet. Add a ready-made one above — the first result appears at the next computation (every 6 hours) or via <strong>Measure Now</strong>.',
        'funnel.addPreset': 'Add a ready-made funnel:',
        'funnel.preset.onboarding': 'Onboarding',
        'funnel.preset.monetization': 'Monetization',
        'funnel.preset.rewarded_ad': 'Rewarded Ad',
        'funnel.metaTotal': 'funnels',
        'funnel.metaMeasured': 'measured',
        'funnel.overall': 'Overall conversion',
        'funnel.window': 'Window',
        'funnel.entered': 'Entered',
        'funnel.inProgress': 'still in window',
        'funnel.lookback': 'lookback',
        'funnel.notMeasuredYet': 'Not measured yet — hit "Measure Now".',
        'funnel.worstStep': 'Biggest drop-off',
        'funnel.lost': 'of players are lost here',
        'funnel.measure': 'Measure Now',
        'funnel.measuring': 'Measuring…',
        'funnel.measureSuccess': '📊 Funnel measured',
        'funnel.delete': 'Delete',
        'funnel.deleteSuccess': '🗑 Funnel deleted',
        'funnel.confirmDelete': 'Delete this funnel? Its measurement history goes too.',
        'funnel.createSuccess': '🔻 Funnel added — hit "Measure Now" for the first result',
        'funnel.noGame': 'Pick a game from the top selector first.',
        'funnel.error': '⚠️ Funnel operation failed',

        // ─── Audit Log + GDPR ───
        'tab.audit': 'Audit Log',
        'audit.banner': '<strong>📋 Audit Log</strong> — Who did what, and when? Every operation that writes config to a live game lands here. <strong>Denied attempts are recorded too</strong> — those are what an auditor actually cares about. The log is <strong>immutable</strong>: it cannot be deleted or edited.',
        'audit.title': 'Recent Operations',
        'audit.refresh': 'Refresh',
        'audit.loading': 'Loading…',
        'audit.empty': 'Hit Refresh to load this game\'s audit log.',
        'audit.noEntries': 'No audit entries for this game yet. They appear when a prescription is applied, an experiment is started, or data is deleted.',
        'audit.denied': 'denied',
        'audit.systemActor': 'system (automatic)',
        'audit.error': 'Could not load audit log',
        'gdpr.title': '🔒 Player Data — Delete & Export',
        'gdpr.legal': 'GDPR Art. 15/17 · KVKK Art. 7',
        'gdpr.banner': 'Use this when a player asks you to <strong>delete their data</strong>. All of that player\'s events, retention record and state snapshots are removed. <strong>Aggregate statistics</strong> (retention rate, funnels, daily stats) are not recomputed — they are anonymous totals and do not identify any single player. Both operations are written to the <strong>audit log</strong>.',
        'gdpr.export': '⬇ Export Their Data (JSON)',
        'gdpr.delete': '🗑 Delete Their Data Permanently',
        'gdpr.needId': 'Enter a playerAnonId in the box above first.',
        'gdpr.confirmPrompt': 'THIS CANNOT BE UNDONE.\n\nAll of this player\'s data will be permanently deleted. Type the playerAnonId exactly to confirm:\n\n{id}',
        'gdpr.confirmMismatch': 'The id did not match — deletion cancelled.',
        'gdpr.exportDone': 'Exported, file downloaded',
        'gdpr.truncated': 'event count hit the cap, the export may be incomplete',
        'gdpr.deleteDone': 'Player data deleted',
        'gdpr.events': 'events',
        'gdpr.rollup': 'retention record',
        'gdpr.snapshots': 'snapshots',
        'section.levelDistributionMeta': 'Completion by level range · last 24h',

        // ─── A/B Experiments ───
        'exp.title': '🧪 A/B Experiments',
        'exp.banner': '<strong>Did the change actually work?</strong> Instead of applying a prescription to everyone at once, test it on <strong>10% of players</strong>. The other 90% is the control group; if the difference is statistically significant you can roll it out. If the treatment group is being harmed, the system <strong>stops it on its own</strong>.',
        'exp.empty': 'No experiments yet. Hit <strong>"Test on 10%"</strong> on a prescription.',
        'exp.metaTotal': 'total',
        'exp.metaRunning': 'running',
        'exp.promote': 'Test on 10%',
        'exp.starting': 'Starting…',
        'exp.startSuccess': '🧪 Experiment started — 10% of players will see the new values',
        'exp.confirmPromote': 'This prescription will be tested on 10% of players. The other 90% stay on current values and act as the control group.\n\nIf the result is statistically significant you can roll it out. If the treatment group is harmed, the system stops it automatically.\n\nStart it?',
        'exp.inExperiment': 'This prescription is currently being measured in an experiment.',
        'exp.currentValues': '(current values)',
        'exp.exposure': 'Exposure',
        'exp.minSample': 'Min sample',
        'exp.needPerVariant': 'needed per variant',
        'exp.guardrail': 'GUARDRAIL',
        'exp.stoppedReason': 'Stop reason',
        'exp.shipped': 'Shipped',
        'exp.abandoned': 'Abandoned',
        'exp.status.running': 'Running',
        'exp.status.stopped': 'Stopped',
        'exp.status.concluded': 'Concluded',
        'exp.verdict.winner': '✅ We have a winner',
        'exp.verdict.control_wins': '⚠️ Current setting is better',
        'exp.verdict.no_difference': '➖ No significant difference',
        'exp.verdict.insufficient_sample': '⏳ Sample too small — result not readable',
        'exp.verdict.guardrail_breach': '🛑 Guardrail breached',
        'exp.verdict.assignment_mismatch': '🛑 Client/server assignment mismatch — result invalid',
        'exp.analyze': 'Measure Now',
        'exp.analyzing': 'Measuring…',
        'exp.analyzeSuccess': '📊 Measurement complete',
        'exp.ship': 'Roll Out',
        'exp.shipSuccess': '🚀 Winning variant applied to all players',
        'exp.confirmShip': 'The winning variant\'s values will be applied to ALL players and the experiment will close. Continue?',
        'exp.stop': 'Stop',
        'exp.stopSuccess': '⏹ Experiment stopped — players reverted to previous values',
        'exp.confirmStop': 'Stop the experiment? Players revert to previous values immediately. Collected measurements are kept.',
        'exp.abandon': 'Abandon',
        'exp.abandonSuccess': '🗑 Experiment abandoned — no values changed',
        'exp.confirmAbandon': 'Abandon this experiment? Nothing changes, the experiment is archived.',
        'autoheal.risk.low': 'low risk',
        'autoheal.risk.medium': 'medium risk',
        'autoheal.risk.high': 'high risk',
        'autoheal.scope': '<strong>Scope:</strong> Auto-Heal solves <strong>config-driven issues</strong> (level difficulty, ad frequency, IAP price, FPS limits, particle quality). For code-level bugs use <strong>Crash & Performance</strong> + AI Copilot. For corrupted state use <strong>Player State Rollback</strong>.',

        // ── Device Intelligence ──
        'device.banner': '<strong>🎮 Device Intelligence</strong> — Which GPU family, RAM tier or device model is accumulating crashes/ANRs/FPS warnings? Concrete targets for AI optimization recommendations.',
        'device.anrs': 'ANR (24h)',
        'device.memWarn': 'Memory Warnings',
        'device.avgFps': 'Avg. FPS',
        'device.lowEndRatio': 'Low-RAM Device Share',
        'device.gpuFamily': 'GPU Family Breakdown',
        'device.problemDevices': 'Problematic Device Models',
        'device.memoryTier': 'RAM Tier Distribution',
        'device.empty': 'Once SDK v2.3+ collects events, GPU family crash/ANR/FPS distribution will appear here.',
        'device.problemEmpty': 'Once crash/ANR events are collected, top problem devices will appear here.',
        'device.memoryEmpty': 'No memory distribution data yet.',

        // ── Player State Rollback ──
        'rollback.banner': '<strong>↺ Player State Rollback</strong> — Whale lost progress? Bugged patch put players in broken state? Lookup by anonymous player ID, list snapshots, restore with one click. Game fetches instantly.',
        'rollback.lookup': 'Lookup Player',
        'rollback.search': 'Search',
        'rollback.restore': 'Restore',
        'rollback.empty': 'Paste playerAnonId and click Search — player snapshot history will appear.',
        'rollback.idPlaceholder': 'playerAnonId (e.g. a3f9c2...)',
        'rollback.idRequired': 'playerAnonId cannot be empty.',
        'rollback.noneFound': 'No snapshots found for this player.',
        'rollback.confirmRestore': 'This snapshot will overwrite the player\'s current state. Continue?',
        'rollback.restored': '✅ Restore queued. Player state will be restored next time they open the game.',

        // ── Industry Benchmark ──
        'industry.banner': '<strong>📊 Industry Benchmark</strong> — Anonymized averages from all <em>same-type</em> games on the Altare platform. Your metrics vs industry median + top 10%. Min 3 games required (privacy).',
        'industry.title': 'Industry Comparison',
        'industry.refresh': '↻ Refresh',
        'industry.loading': 'Loading industry data…',
        'industry.empty': 'Click "Refresh" to load the industry benchmark. If not enough games (min 3) you\'ll see "not ready yet".',
        'industry.avgSession': 'Avg Session (s)',
        'industry.failRate': 'Level Fail Rate',
        'industry.crashRate': 'Crash Rate',
        'industry.fpsWarnRate': 'FPS Warning Rate',
        'industry.adsPerSession': 'Ads per Session',
        'industry.iapPerPlayer': 'IAP per Player',
        'industry.sessionsPerPlayer': 'Sessions per Player',
